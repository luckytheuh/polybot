...
public class TooFarCommand extends SlashCommand {

    public TooFarCommand() {
        super("science", Category.MEDIA, "Has science gone too far?");
        ...
        this.aliases = new String[]{"hassciencegonetoofar", "hsgtf", "toofar"};
